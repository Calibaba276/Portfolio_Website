...
export async function askAI(userInput: string): Promise<string> {
  // Check if the question is about Utkarsh (case-insensitive)
  const aboutUtkarsh = /utkarsh|you|your|yours|yourself|portfolio|project|work|experience|skills/i.test(userInput);

  const systemPrompt = aboutUtkarsh
    ? `
You are Shadow, a helpful AI assistant for Utkarsh's portfolio terminal. You answer questions on behalf of Utkarsh, and responding in a friendly, concise manner. You can sometimes be sarcastic and make jokes about them 
